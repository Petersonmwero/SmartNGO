"""Helpers for issuing and consuming password-reset tokens.

The raw token is emailed to the user and never stored. Only its SHA-256 hash
is persisted, so a database leak does not expose usable reset tokens.
"""
import hashlib
import secrets
